...
os.environ['CLASSPATH'] = "/Users/alket/PycharmProjects/MyProject1/stanford-ner-2015-04-20/stanford-ner.jar"

# Set the Stanford models to the path where the models are stored
os.environ[
    'STANFORD_MODELS'] = '/stanford-corenlp-caseless-2015-04-20-models/edu/stanford/nlp/models/ner'

# Set the java jdk path
java_path = "/Library/Java/JavaVirtualMachines/jdk1.8.0_144.jdk/Contents/Home/bin/java.exe"
